...
namespace GFin.Negocio
{
    public class UsuarioNegocio : GenericNegocio
    {
        ...
        public UsuarioNegocio(IClienteListener clienteListener) : base(clienteListener) {}
        ...
        public UsuarioAcessoEntidadeControle RegistrarUsuario(UsuarioAcessoEntidadeControle usuarioAcessoEntidade)
        {
            ...
            GravarHistoricoUsuario(usuarioAcessoEntidade.UsuarioAcesso.Id,
                    ...
                    string.Format("Registrado com o perfil [{0}]", UtilEnum.GetTextoTipoPerfilAcessoUsuario(usuarioAcessoEntidade.CodigoTipoPerfilAcesso)));
        ...
        public void EnviarSolicitacaoConfirmacaoEmailUsuario(UsuarioSistema usuarioSistema)
        {
            ...
            var pathEmailConfirmacao = string.Format("{0}\\Content\\html\\emailConfirmacaoUsuario.html", this.ClienteListener.MapPathAppServidor);
            ...
            EmailNegocio.Instance.EnviarEmail(usuarioSistema.EmailUsuario, usuarioSistema.NomeUsuario, "Gerenciador Financeiro - Confirmação de Registro", mensagemEmail, anexos);
        ...
        private void ValidarUsuario(UsuarioSistema usuario)
        {
            ...
            if (!UtilNegocio.ValidarEmail(usuario.EmailUsuario))
                throw new NegocioException(string.Format("E-mail do usuário [{0}] é inválido, favor informar um e-mail válido.", usuario.EmailUsuario));
            ...
            if (usuario.Id == 0)
            {
                ...
                if (this.IsUsuarioSistemaExistente(usuario.EmailUsuario))
                    throw new NegocioException(string.Format("E-mail do usuário [{0}] já registrado, caso tenha esquecido sua senha, utilize a funcionalidade de 'esqueci minha senha'.", usuario.EmailUsuario));
        ...
        public void ConfirmarEmailUsuario(UsuarioSistema usuarioSistema)
        {
            ...
            GravarHistoricoUsuario(usuarioSistema.Id,
                ...
                string.Format("Confirmado em {0}.", DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss")));
        ...
        public void EnviarSolicitacaoRecuperacaoSenhaUsuario(string nomeUsuario, string emailUsuario, string codigoSeguranca)
        {
            ...
            //Recuperar mensagem para o envio.
            var pathHtmlEmail = string.Format("{0}\\Content\\html\\emailRecuperacaoSenhaUsuario.html", this.ClienteListener.MapPathAppServidor);
            ...
            EmailNegocio.Instance.EnviarEmail(emailUsuario, nomeUsuario, "Gerenciador Financeiro - Recuperação de Senha", mensagemEmail, anexos);
        ...
        public void RedefinirSenhaUsuario(int idUsuario, string novaSenha, string confirmacao)
        {
            ...
            if (_usuario == null)
                throw new NegocioException(string.Format("Não foi possível encontrar o usário com o identificador [{0}] informado.", idUsuario));
            ...
            GravarHistoricoUsuario(_usuario.Id,
                ...
                string.Format("Senha antiga [{0}], salt [{1}].", antigaSenha, antigoSaltSenha));
        ...
        public void AlterarNomeEmailUsuario(int idUsuario, string nomeUsuario, string emailUsuario)
        {
            ...
            if (!UtilNegocio.ValidarEmail(emailUsuario))
                throw new NegocioException(string.Format("E-mail do usuário [{0}], utilizado no login, inválido.", emailUsuario));
            ...
            {//Somente alterar os dados caso identificado mudança.
                ...
                GravarHistoricoUsuario(_usuario.Id,
                    ...
                    string.Format("Dados anteriores - Nome: {0}, e-mai: {1}", _nomeAnterior, _emailAnterior));
