...
namespace GFin.Negocio
{
    ...
    {
        public ReceitaNegocio(GFin.Negocio.Listeners.IClienteListener clienteListener) : base(clienteListener) { }
        /// <summary>
        ...
        private void ValidarReceita(ReceitaMensal receita)
        {
            ...
            {//Verificar se a natureza informada existe...
                throw new NegocioException(string.Format("Natureza da Receita (Id: {0}) não existe ou está inativa.", receita.NaturezaContaReceita.Id));
            }
        ...
        private void ValidarReceitaFixa(ReceitaFixa receita)
        {
            ...
            {//Verificar se a natureza informada existe...
                throw new NegocioException(string.Format("Natureza da Receita Fixa (Id: {0}) não existe ou está inativa.", receita.NaturezaContaReceitaFixa.Id));
            }
        ...
        public void RemoverReceitaFixa(ReceitaFixa receitaFixa)
        {
            ...
            using (IUnitOfWork uofw = new UnitOfWork())
            {
                ...
                {
                    throw new NegocioException(string.Format("Não foi possível encontrar a receita fixa com o Id [{0}].", receitaFixa.Id));
                }
        ...
        public void RemoverReceitaFixa(int idReceitaFixa)
        {
            ...
            using (IUnitOfWork uofw = new UnitOfWork())
            {
                ...
                if (_receitaFixa == null)
                    throw new NegocioException(string.Format("Não foi possível encontrar a receita fixa com o Id [{0}].", _receitaFixa.Id));
        ...
        public void RemoverReceitaMensal(int idReceita)
        {
            ...
            using (IUnitOfWork uofw = new UnitOfWork())
            {
                ...
                if (_receita == null)
                    throw new NegocioException(string.Format("Não foi encontrado a receita mensal com o Id [{0}] para remoção.", idReceita));
        ...
        public void LiquidarReceita(int idReceita, DateTime dataLiquidacao, decimal valorTotalLiquidacao)
        {
            ...
            if (_receita == null)
                throw new NegocioException(string.Format("Receita mensal com o Id [{0}] não encontrada para liquidação.", idReceita));
            if (_receita.IsReceitaLiquidada)
                throw new NegocioException("Receita mensal já liquidada, alterações não permitidas.");
