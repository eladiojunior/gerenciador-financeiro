...
namespace GFin.Dados
{
    ...
    internal class UnitOfWork : IUnitOfWork
    {
        ...
        public DespesaMensalDAO DespesaMensal
        {
            get
            {
                if (_despesaMensal == null)
                    _despesaMensal = new DespesaMensalDAO(_context);
                return _despesaMensal;
            }
        }

        public DespesaFixaDAO DespesaFixa
        {
            get
            {
                if (_despesaFixa == null)
                    _despesaFixa = new DespesaFixaDAO(_context);
                return _despesaFixa;
            }
        }
