...
namespace gfin.webapi.Negocio
{
    ...
    {
        public EntidadeControleNegocio(IClienteListener cliente, GFinContext context) : base(cliente, context) { }
        /// <summary>
                ...
                using (IUnitOfWork uofw = new UnitOfWork(GFinContext))
                {
                    ...
                    if (qtdRegs > 0)
                        throw new NegocioException(
                            $"Já existe um registro para {(isEmpresa ? "a empresa" : "o responsável")} com o número {(isEmpresa ? "do CNPJ" : "do CPF")} [{entidade.CpfCnpjEntidade}] informado.");
                }
            }
        }
        ...
        public void RemoverEntidadeControle(EntidadeControle entidade)
        {
            ...
            using (IUnitOfWork uofw = new UnitOfWork(GFinContext))
            {
                ...
                if (_entidade == null)
                    throw new NegocioException(
                        $"Não foi possível encontrar a entidade de controle com o Id [{entidade.Id}].");
        ...
        public void AlterarNomeCnpjEntidadeControle(int idEntidade, short codigoTipoEntidadeControle, string nomeEntidadeControle, string cpfCnpjEntidadeControle)
        {
            ...
            if (_entidade == null)
                throw new NegocioException(
                    $"Não foi possível encontrar a entidade com o identificador [{idEntidade}] informado.");
            ...
            {//Somente alterar os dados caso identificado mudanças.
                ...
                GravarHistoricoUsuario(_entidade.Id,
                    ...
                    $"Dados anteriores - tipo: {_entidade.CodigoTipoEntidade}, nome: {_nomeAnterior}, cpfCnpj: {_cpfCnpjAnterior}");
