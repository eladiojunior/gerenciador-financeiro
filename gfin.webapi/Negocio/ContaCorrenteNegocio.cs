...
namespace gfin.webapi.Negocio
{
    ...
    {
        public ContaCorrenteNegocio(IClienteListener cliente, GFinContext context) : base(cliente, context) { }
        /// <summary>
        ...
        private void ValidarContaCorrente(ContaCorrente contaCorrente)
        {
            ...
            {
                contaCorrente.IdEntidade = ClienteListener.UsuarioLogado.IdEntidade;
            }
            ...
            using (IUnitOfWork uofw = new UnitOfWork(GFinContext))
            {
                ...
                if (contaCorrente == null)
                {
                    throw new NegocioException(
                        $"Não foi possível encontrar a conta corrente com o Id [{idContaCorrente}] informado.");
                }
