...
namespace gfin.webapi.Negocio
{
    ...
    {
        public ProcessoAutomaticoNegocio(IClienteListener cliente, GFinContext context) : base(cliente, context) { }
        ...
        private void ValidarProcesso(ProcessoAutomatico processo)
        {
            ...
            if (!UtilEnum.IsEnumValido(typeof(TipoProcessoAutomaticoEnum), processo.CodigoTipoProcessoAutomatico))
            {
                throw new NegocioException(
                    $"Tipo do processo automático [{processo.CodigoTipoProcessoAutomatico}] inválido.");
            }
